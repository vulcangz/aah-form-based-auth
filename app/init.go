...
func init() {
	...
	app.AddTemplateFunc(template.FuncMap{
		"myisauthenticated": util.TmplIsAuthenticated,
		"myhasrole":         util.TmplHasRole,
		"myhasallroles":     util.TmplHasAllRoles,
		"myhasanyrole":      util.TmplHasAnyRole,
		"myispermitted":     util.TmplIsPermitted,
		"myispermittedAll":  util.TmplIsPermittedAll,
	})
